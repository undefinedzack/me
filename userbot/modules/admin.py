...
@register(outgoing=True, pattern="^.setgrouppic$", group_only=True)
...
@register(outgoing=True, pattern="^.promote(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.demote(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.ban(?: |$)(.*)", group_only=True)
async def ban(bon):
...
@register(outgoing=True, pattern="^.unban(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.mute(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.unmute(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.ungmute(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.gmute(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.delusers(?: |$)(.*)", group_only=True)
...
@register(outgoing=True, pattern="^.admins$", group_only=True)
...
@register(outgoing=True, pattern="^.pin(?: |$)(.*)", group_only=True)
async def pin(msg):
...
@register(outgoing=True, pattern="^.kick(?: |$)(.*)", group_only=True)
async def kick(usr):
...
async def get_user_from_event(event):
    ...
    extra = None
    if event.reply_to_msg_id and not args:
